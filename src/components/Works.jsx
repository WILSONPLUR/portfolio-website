...
const ProjectCard = ({
  ...
  return (
    <div className="h-fit green-pink-gradient p-[1px] rounded-2xl shadow-card">
      <div
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>{t("myWorks.subtitle")}</p>
        <h2 className={styles.sectionHeadText}>{t("myWorks.title")}</h2>
      </motion.div>
